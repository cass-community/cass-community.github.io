...
long_description: |
    ...
    It enables developers of science and engineering applications and libraries to write single source code that can run
    efficiently on diverse hardware architectures from your laptop to the largest exascale super computers. Specifically,
    Kokkos supports CPUs and GPUs from all major vendors. The Kokkos team is also heavily involved in codesign efforts to
    leverage future architectures.
...
additional_resource_links:
   ...
   - label: Downloads
     url: https://github.com/kokkos/kokkos/releases
#   - label: Documentation
#     url: 
#
