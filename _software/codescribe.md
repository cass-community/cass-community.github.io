...
long_description: |
    CodeScribe is  a tool for semi-automatic translation of production level scientific code from Fortran to C++, and also for generating new code with LLMs using prompts and chat completion 
target_audience: |
