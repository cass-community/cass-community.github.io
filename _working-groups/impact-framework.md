...
The first version of the Impact Framework document was approved by the CASS Steering Committee on 2025-09-08, with subsequent minor updates to harmonize with the work of the [Metrics Working Group]({% link _working-groups/metrics.md %}). On 2026-02-24, we added a separate document to collect baseline information for each software product. We plan to work with member organizations and their stewarded product teams to roll out the document to capture progress and plans for stewardship activities starting in Fall 2025. Where possible, we plan to do this as part of each member organization's planning and reporting cycle, though in some cases we may initially be out of cycle.

- Baseline (single use): [PDF](/assets/wg/impact-framework/Impact%20Framework%20BASELINE%20v01final.pdf) \| [Word](/assets/wg/impact-framework/Impact%20Framework%20BASELINE%20v01final.docx)
- Impact Framework (recurring use): [PDF](/assets/wg/impact-framework/Impact%20Framework%20v01final.pdf) \| [Word](/assets/wg/impact-framework/Impact%20Framework%20v01final.docx)