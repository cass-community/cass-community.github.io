...
long_description: |
    ChatVis is both an agent for automatically generating scientific visualizations from natural language prompts and a benchmark for evaluating synthetically-generated visualizations, whether generated by ChatVis or other tools. ChatVis_agent is an LLM agent that aids the LLM to generate Python code for ParaView scientific visualization tasks. ChatVis_benchmark is a benchmark suite of canonical visualization tasks, ParaView regression tests, and scientific use cases that includes comprehensive evaluation metrics.
target_audience: |
    ParaView users, domain scientists, visualization researchers.
#
